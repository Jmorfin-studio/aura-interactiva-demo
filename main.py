...
# Ya no se necesita Deepgram en esta arquitectura
...
# La clave de Deepgram ya no es necesaria
...
# --- 3. LÓGICA DE WEBSOCKET (SIMPLIFICADA PARA RECIBIR TEXTO) ---
prompt_template_str = """
...
async def websocket_endpoint(websocket: WebSocket, session_id: str):
    ...
    try:
        while True:
            # El backend ahora simplemente espera recibir texto plano del frontend
